...
<div class="card card-border-shadow-primary mb-4">
    <div class="card-body">
        <div class="d-flex justify-content-between">
            <h4 class="card-title">{{ $tp_culto }} - Adicionar</h4>
        </div>
        <hr>
        <form id='formulario' action="{{ route('cultos.insert') }}" method="post">
            @csrf
            <input type="hidden" name="tp_culto" value="{{ $tp_culto }}">
            <div class="row">
                ...
                <div class="col-md-6 mt-3">
                    <div class="form-floating form-floating-outline">
                        ...
                        <label for="nm_culto">Culto:</label>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 mt-3">
                    <div class="form-floating form-floating-outline">
                        ...
                        <label for="ds_culto">Descrição do Culto:</label>
                    </div>
                </div>
            </div>
            <div class="mt-4">
