...
<html
  ...
  <head>
    ...
    <title>Geração Vida - Sistema Online</title>
    ...
    .imgFundo{
        ...
        background-image: url({{ asset('/public/img/por-que-ceu-azul.jpg') }});
    }
    </style>
  </head>
              ...
              <a href="/" class="app-brand-link gap-2">
                <span class="app-brand-logo demo">
                  <span style="color: #666cff">
                    <img src="{{ asset('/public/img/logo.png') }}" style='height: 200px' alt="">
                  </span>
                </span>
