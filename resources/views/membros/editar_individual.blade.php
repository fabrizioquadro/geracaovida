        ...
        <form action="{{ route('membros.update') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-3 mt-3">
                    <div class="form-floating form-floating-outline">
                        <select class="form-select" id="conjugue" name='conjugue' aria-label="Default select example">
                            <option value=""></option>
                            @foreach($membros as $conjugue)
                                @php
                                $controle = false;
                                if($membro->conjugue() && $conjugue->id == $membro->conjugue()->id){
                                    $controle = true;
                                }
                                @endphp
                                @if(!$conjugue->conjugue() || $controle)
                                    <option @if($membro->conjugue() && $conjugue->id == $membro->conjugue()->id) selected @endif value="{{ $conjugue->id }}">{{ $conjugue->nome }}</option>
                                @endif
                            @endforeach
                        </select>
            ...
            <div class="row">
                ...
                @if($membro->situacao == "Membro")
                    ...
                    <div class="col-md-2 mt-3">
                        <div class="form-floating form-floating-outline">
                            <input class="form-control" type="text" id="st_batismo" name="st_batismo" value="{{ $membro->st_batismo }}"/>
                ...
                @else
                    ...
                    <div class="col-md-3 mt-3">
                        <div class="form-floating form-floating-outline">
                            <input class="form-control" type="text" id="como_veio" name="como_veio" value="{{ $membro->como_veio }}"/>
            ...
            <div class="row">
                ...
                @else
                    <div class="col-md-3 mt-3">
                        <div class="form-floating form-floating-outline">
                            <input class="form-control" type="text" id="aceita_msg" name="aceita_msg" value="{{ $membro->aceita_msg }}"/>
